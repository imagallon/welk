        ...
        <Tabs>
          ...
          <TabPanel>
            ...
            <div className='md:w-1/2 bg-white rounded-lg p-12 font-secondary'>
             ...
             <div className='md:w-1/2'>
               <img src={serviceImg2} alt="image of a coding IDE" className='w-full h-auto rounded-2xl object-cover' />
             </div>
            </div>
           ...
           <TabPanel>
            ...
            <div className='md:w-1/2 bg-white rounded-lg p-12 font-secondary'>
             ...
             <div className='md:w-1/2'>
               <img src={serviceImg3} alt="image of a coding IDE" className='w-full h-auto rounded-2xl object-cover' />
             </div>
            </div>
