...
const Contact = () => {
    ...
    const [showModal, setShowModal] = useState(false); // Initialize as boolean false
                        ...
                        <form onSubmit={handleSubmit} className='space-y-8'>
                            <div className='flex sm:flex-row flex-col gap-4'>
                                <input
                                    ...
                                    type="text"
                                    placeholder='Name'
                                    className='w-full p-4 rounded-md focus:outline-none focus:ring-2 focus:ring-primary'
                                />
                                <input
                                    value={email}
